...
By removing these two adverse effects via the YANG augment specified in this memo, it becomes possible, for example, for a RATS Verifier to maintain a continuous appraisal procedure of verifiably fresh Attester Evidence without relying on continuous polling.
